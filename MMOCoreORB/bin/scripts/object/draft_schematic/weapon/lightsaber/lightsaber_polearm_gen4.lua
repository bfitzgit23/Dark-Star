...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_gen4:new {
   ...
   ingredientTitleNames = {"emitter_shroud", "primary_crystal", "activator", "handgrip", "1st focusing_crystal", "focusing_crystals", "focusing_crystals", "power_field_insulator", "energizers"},
