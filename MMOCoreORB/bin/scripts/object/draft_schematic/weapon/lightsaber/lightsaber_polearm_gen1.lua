...
object_draft_schematic_weapon_lightsaber_lightsaber_polearm_gen1 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_polearm_gen1:new {
   ...
   resourceTypes = {"mineral", "object/tangible/component/weapon/lightsaber/shared_lightsaber_refined_crystal_pack.iff", "metal", "chemical", "gas", "metal"},
   resourceQuantities = {25, 1, 25, 25, 25, 25},
