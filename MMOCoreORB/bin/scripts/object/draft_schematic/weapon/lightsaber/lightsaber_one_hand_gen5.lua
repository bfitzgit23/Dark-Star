...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_gen4:new {
   ...
   ingredientTitleNames = {"emitter_shroud", "primary_crystal", "activator", "handgrip", "focusing_crystals", "power_field_insulator", "energizers", "primary_crystal", "primary_crystal"},
   ...
   resourceQuantities = {40, 1, 22, 28, 1, 28, 28, 1, 1},
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen4, "object/draft_schematic/weapon/lightsaber/lightsaber_one_hand_gen5.iff")
