...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen4 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_gen4:new {
   ...
   ingredientTitleNames = {"emitter_shroud", "primary_crystal", "activator", "handgrip", "1st focusing_crystal", "2nd focusing_crystal", "3rd focusing_crystal", "power_field_insulator", "energizers"},
