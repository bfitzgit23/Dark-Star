...
corellia = {
	...
	planetTravelPoints = {
		...
		{name = "Coronet Starport", x = -138, z = 28, y = -4722, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Tyrena Starport", x = -5036, z = 21, y = -2291, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Kor Vella Starport", x = -3138, z = 31, y = 2808, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
	...
	planetObjects = {
		...
		-- {templateFile = "object/tangible/terminal/terminal_character_builder.iff", ox = 0, oy = -0.666281, oz = 0, ow = 0.745701, x = -3272, z = 86, y = 3111, parentid = 0}
	}
}
...
naboo = {
	...
	planetTravelPoints = {
		{name = "Keren Starport", x = 1438, z = 13, y = 2771, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Theed Spaceport", x = -4858.834, z = 5.9483199, y = 4164.0679, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		{name = "The Lake Retreat", x = -5494.4224, z = -150, y = -21.837162, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Moenia", x = 4799, z = 4.1700001, y = -4697, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
...
rori = {
	...
	planetTravelPoints = {
		{name = "Restuss Starport", x = 5364, z = 80, y = 5663, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
...
talus = {
	...
	planetTravelPoints = {
		{name = "Dearic Starport", x = 331, z = 6, y = -2930, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
...
tatooine = {
	...
	planetTravelPoints = {
		...
		{name = "Mos Eisley Starport", x = 3532, z = 5, y = -4803, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		{name = "Bestine Starport", x = -1291, z = 12, y = -3590, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
		...
		{name = "Mos Espa Starport", x = -2902, z = 5, y = 2127, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 3},
